  ...
  return (
    <button
      className={cn(
        ...
        variant === "primary" &&
          "bg-[#008751] text-white shadow-[0_12px_26px_rgba(0,135,81,0.18)] hover:bg-[#005C35]",
        variant === "secondary" &&
          "border border-black/10 bg-white text-[#0A0A0A] hover:bg-black/[0.03]",
        variant === "dark" &&
          "bg-[#0A0A0A] text-white shadow-[0_12px_26px_rgba(10,10,10,0.16)] hover:bg-black/80",
        variant === "ghost" &&
          "bg-transparent text-[#0A0A0A] hover:bg-black/[0.04]",
        className,
      )}
      {...props}
    />
